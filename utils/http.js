module.exports = {
  http(url, method, params) {
    ...
    wx.request({
      // url: 'http://127.0.0.1:4523/mock/433604' + url, 
      url: 'https://seuclab.cn/to/xu-doctor/dev' + url,
       //拼接上前缀,此接口域名是开放接口，可访问
      method: method == 'POST' ? 'POST' : (method == 'GET' ? 'GET' : 'PUT'), // 判断请求类型，除了值等于'POST'外，其余值均视作GET 其他的请求类型也可以自己加上的
      data,
      header: {
